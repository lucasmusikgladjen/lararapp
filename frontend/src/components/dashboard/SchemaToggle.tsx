    ...
    <View className="flex-row bg-gray-100 rounded-full p-1 mb-4">
      <TouchableOpacity
        ...
        className={`flex-1 py-2.5 rounded-full items-center ${
          activeTab === "kommande" ? "bg-brand-green" : ""
        }`}
        activeOpacity={0.8}
      >
        <Text
          className={`font-semibold text-sm ${
            activeTab === "kommande" ? "text-white" : "text-gray-500"
          }`}
        >
          Kommande
        </Text>
      ...
      <TouchableOpacity
        ...
        className={`flex-1 py-2.5 rounded-full items-center ${
          activeTab === "senaste" ? "bg-brand-green" : ""
        }`}
        activeOpacity={0.8}
      >
        <Text
          className={`font-semibold text-sm ${
            activeTab === "senaste" ? "text-white" : "text-gray-500"
          }`}
        >
          Senaste
        </Text>
